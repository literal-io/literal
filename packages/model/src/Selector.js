...
function rangeSelector_decode(v) {
  ...
  if (startSelector.TAG === /* Ok */0) {
    ...
    var e$2 = endSelector._0;
    return {
            TAG: /* Error */1,
            _0: {
              path: ".endSelector" + e$2.path,
              message: e$2.message,
              value: e$2.value
            }
          };
  }
  var e$3 = startSelector._0;
  return {
          TAG: /* Error */1,
          _0: {
            path: ".startSelector" + e$3.path,
            message: e$3.message,
            value: e$3.value
          }
        };
...
function xPathSelector_decode(v) {
  ...
  if (value.TAG === /* Ok */0) {
    ...
    var e$2 = refinedBy._0;
    return {
            TAG: /* Error */1,
            _0: {
              path: ".refinedBy" + e$2.path,
              message: e$2.message,
              value: e$2.value
            }
          };
...
function t_decode$1(json) {
  ...
  if (textPositionSelector.TAG === /* Ok */0) {
    return {
            TAG: /* Ok */0,
            _0: {
              TAG: /* TextPositionSelector */2,
